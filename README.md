...
&nbsp;&nbsp;📂 **Main Portfolio**<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;┣&nbsp;&nbsp;🎮 **Unity-Projects**<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;┣&nbsp;&nbsp;🎨 [Shader-Tool](URL_HERE) — *HLSL Editor*<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;┗&nbsp;&nbsp;⚡ **ECS-Framework**<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;┣&nbsp;&nbsp;⚙️ [Core-Library](URL_HERE)<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;┗&nbsp;&nbsp;🧪 [Framework-Demo](URL_HERE)<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;┣&nbsp;&nbsp;🛠️ **C#-Pure**<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;┣&nbsp;&nbsp;🧩 [Project-One](URL_HERE)<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;┗&nbsp;&nbsp;🧮 [Project-Two](URL_HERE)<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;┗&nbsp;&nbsp;🌐 **Web-Tools**<br>
&nbsp;&nbsp;┃&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;┗&nbsp;&nbsp;📍 [Chrome-Overlay](URL_HERE) — *JS + CSS*


### 📂 Project Directory

- 📂 **Main Portfolio** <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;┣&nbsp;&nbsp;🎮 **Unity-Projects** `gamedev` `engine` <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;┣&nbsp;&nbsp;🎨 [Shader-Tool](URL) `graphics` `hlsl` <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;┗&nbsp;&nbsp;⚡ **ECS-Framework** `performance` <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;┣&nbsp;&nbsp;⚙️ [Core-Library](URL) `c#` <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;┗&nbsp;&nbsp;🧪 [Framework-Demo](URL) `unity` <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;┣&nbsp;&nbsp;🛠️ **C#-Pure** `logic` <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;┣&nbsp;&nbsp;🧩 [Project-One](URL) `c#` <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;┃&nbsp;&nbsp;┗&nbsp;&nbsp;🧮 [Project-Two](URL) `math` <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;┗&nbsp;&nbsp;🌐 **Web-Tools** `chrome-ext` <br>
  &nbsp;&nbsp;┃&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;┗&nbsp;&nbsp;📍 [Chrome-Overlay](URL) `js` `css`

  ### 📂 Project Directory

| Category | Projects | Tech Stack |
| :--- | :--- | :--- |
| **🎮 Unity** | [Shader Tool](URL) <br> [ECS Framework](URL) | `HLSL` `C#` |
| **⚡ ECS Demo** | [Framework Demo](URL) | `DOTS` `Unity` |
| **🛠️ C# Pure** | [Async Messenger](URL) <br> [Math Utils](URL) | `.NET` `C#` |
| **🌐 Web** | [Chrome Overlay](URL) | `JS` `CSS` |
